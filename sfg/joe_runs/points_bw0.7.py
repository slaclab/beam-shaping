...
filename = glob.glob('/Users/nneveu/github/beam-shaping/sfg/datasets/*0.7*.npy')
...
# roughly 1 mm
# six runs for bw0.7
mask = (data['rms_s']>0.00093) & (data['rms_s']<0.00103) & (data['emit_x']<0.42e-6)
#print(data[mask]['emit_x'])
# cut data
cut = data[mask]
#print('emittance:', cut[i]['emit_x'])
#print('bunch length:', cut[i]['rms_s'])
#print('x values', cut['individual'])
