...
datadir = '/Users/nneveu/github/beam-shaping/sfg/datasets/'

filenames = [#'1030nm_results/deap_run3_gauss_nosample_history_length=5300_evals=5274.npy', 
             #'1030nm_results/deap_ssnl_bw0.5_32MV_history_length=7000_evals=6570_workers=36.npy',
             'experimental/deap_raw_exp_len=2500.npy',
             'experimental/deap_smooth_exp_len=3100.npy',]

titles = ['Exp. Raw', 'Exp. Smooth']
